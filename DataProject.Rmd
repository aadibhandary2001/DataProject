...
We could overcome this bimodality by including sex as a categorical predictor, however our goal is to abstract general, functional, relationship between our predictors and medal odds. Including sex adds no new meaning if it just shifts the curve with the same linear relationships.
...
We will be testing 3 (maybe 4?) model configurations based on our basic biological predictors: Height, Weight, and Age.
...
#Plot ROC Curves
plot(base_log_reg_roc, col = "blue", main = "ROC Curves for Different Models")
lines(step_roc, col = "green")
legend("bottomright", 
